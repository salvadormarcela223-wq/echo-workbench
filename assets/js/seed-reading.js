...
window.SEED_READINGS = [
  {
    ...
    body: [
      ...
      "Conventional <u>sensory</u> testing is built on decomposition. A trained panel takes a product apart into <u>attributes</u>, scores each one on a scale, and hands marketing a spreadsheet. It is rigorous, replicable and, in a narrow sense, scientific. But it is also <u>inherently</u> <u>constrained</u>: a scale can only measure what somebody thought to put on it. The result is an industry that is extremely good at optimising the dimensions it already knows about, and structurally blind to everything else.",
      "This blindness is expensive. Research from Mintel found that 76% of beauty and personal care users say texture shapes their experience of a product, and 75% believe texture is related to how well the product works. Read that second figure again. Consumers are not merely enjoying texture; they are using it as <u>evidence</u>. Because efficacy is invisible, the senses become a <u>proxy</u> for it. A cooling tingle signals active ingredients. A slow, heavy glide signals nourishment. These inferences are learned, cultural and entirely reverse-engineerable — and yet most brands still design them by instinct.",
      "The Nairobi team used an AI moderator trained to speak the language of the senses, prompting people to narrate rather than rate. What emerged was not a cleaner dataset but a different <u>genre</u> of finding: quality, in that market, was not a checklist but a feeling of being cared for. The smooth <u>extrusion</u> from the tube. The mint that lingered just long enough. The lid.",
      "There is a broader lesson here about the current <u>enthusiasm</u> for artificial participants. If a model can only interpolate from what it has already absorbed, it will reliably reproduce the attributes we have historically measured — and never surprise us with a lid. The most valuable ten seconds of any interview is usually the moment a respondent <u>misunderstands</u> the question, because the misunderstanding exposes the gap between our mental model and theirs. Machines are trained not to misunderstand us. They are trained to agree.",
      "None of this means abandoning measurement. It means <u>demoting</u> it — from the method to one method. Leave ten unstructured minutes at the end of every test. Ask people to tell you a story instead of giving you a annex. You will collect things no scale could have caught, and occasionally one of them will be worth more than the rest of the study combined."
    ],
    vocab: [
      { w: 'sensory', p: '/ˈsensəri/', t: 'adj. 感官的，感觉的', lv: 'IELTS' },
      { w: 'attribute', p: '/ˈætrɪbjuːt/', t: 'n. 属性，特质（感官分析中指"感官属性"）', lv: 'TOEFL' },
      { w: 'inherently', p: '/ɪnˈhɪərəntli/', t: 'adv. 内在地，本质上', lv: 'TOEFL' },
      { w: 'constrained', p: '/kənˈstreɪnd/', t: 'adj. 受约束的，受限的', lv: 'IELTS' },
      { w: 'evidence', p: '/ˈevɪdəns/', t: 'n. 证据，依据', lv: '商务' },
      { w: 'proxy', p: '/ˈprɒksi/', t: 'n. 代理，替代指标（研究中的"代理变量"）', lv: 'TOEFL' },
      { w: 'genre', p: '/ˈʒɒnrə/', t: 'n. 类型，体裁', lv: 'IELTS' },
      { w: 'extrusion', p: '/ɪkˈstruːʒn/', t: 'n. 挤出，挤压成形', lv: '专业' },
      { w: 'enthusiasm', p: '/ɪnˈθjuːziæzəm/', t: 'n. 热情，热衷', lv: 'IELTS' },
      { w: 'misunderstand', p: '/ˌmɪsʌndəˈstænd/', t: 'v. 误解，会错意', lv: '基础' },
      { w: 'demote', p: '/ˌdiːˈməʊt/', t: 'v. 降级，降低地位', lv: 'TOEFL' },
      { w: 'replicable', p: '/ˈreplɪkəbl/', t: 'adj. 可复现的（科研核心词）', lv: '学术' }
    ],
    phrases: [
      { en: 'a promise kept', zh: '一个被兑现的承诺' },
      { en: 'structurally blind to', zh: '在结构上对……视而不见' },
      { en: 'reverse-engineer', zh: '逆向工程，反推出机理' },
      { en: 'worth more than the rest of the study combined', zh: '比整个研究的其余部分加起来还有价值' }
    ]
  },
  {
    id: 'r-02',
